...
//    private static final Dimension CHESSGRID_SIZE = new Dimension(1080 / 4 * 3 / 8, 1080 / 4 * 3 / 8);
    private static final Color[] BACKGROUND_COLORS = {new Color(212, 173, 227, 71), new Color(252, 138, 69, 56)};
    /**
     * handle click event
     */
    ...
    public void setpath(boolean pathed){
        this.pathed=pathed;
    }
...
//     private Image bb;
//     public void loadRe() throws IOException{
//         aa=ImageIO.read(new File("./1.jpg"));
//     }
//     private void iniaa(){
//         try{
//             loadRe();
...
//            e.printStackTrace();
//        }
//        g.drawImage(bb,0,0,getWidth(),getHeight(),this);
